      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold tracking-tight">6CATRIP</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed max-w-xs">
              Experience the world with 6CATRIP. We provide premium travel experiences, curated just for you. Discover your next adventure today.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} 6CATRIP. All rights reserved.
          </p>
