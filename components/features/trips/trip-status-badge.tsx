...
import { Trip, TripCustomer } from "@/lib/mock-data/trips";
...
interface CustomerPaymentStatusBadgeProps {
  status: TripCustomer['paymentStatus'];
  className?: string;
}

export function CustomerPaymentStatusBadge({ status, className }: CustomerPaymentStatusBadgeProps) {
  const getStyle = () => {
    switch (status) {
      case 'paid':
